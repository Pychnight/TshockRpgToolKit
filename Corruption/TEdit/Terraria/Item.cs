...
namespace Corruption.TEdit //TEditXNA.Terraria
{
	...
	public class Item //: ObservableObject
	{
		...
		public string PrefixName => World.ItemPrefix.Count > Prefix ? World.ItemPrefix[Prefix] : "Unknown " + Prefix.ToString();
		...
		public byte Prefix { get => _prefix; set => _prefix = value; }
		...
		public Item Copy() => new Item(_stackSize, _netId) { Prefix = _prefix };
