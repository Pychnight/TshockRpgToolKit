...
namespace CustomNpcs.Npcs
{
	...
	public sealed class CustomNpc : CustomEntity<NPC, NpcDefinition>
	{
		...
		public void ShootCustomProjectileAt(Vector2 target, string projectileName, float speed) => ShootCustomProjectileAt(target, projectileName, speed, new Vector2(0, 0));
		...
		/// </summary>
		public void TargetClosestPlayer() => Npc.TargetClosest();

		/// <summary>
		///     Teleports the NPC to the specified position.
		/// </summary>
		/// <param name="position">The position.</param>
		public void Teleport(Vector2 position) => Npc.Teleport(position);
