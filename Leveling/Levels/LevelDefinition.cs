...
namespace Leveling.Levels
{
    ...
    public sealed class LevelDefinition
    {
        ...
        public IList<string> CommandsOnLevelDown { get; private set; }

        /// <summary>
        ///     Gets the list of commands to execute on leveling up.
        /// </summary>
        [JsonProperty("CommandsOnLevelUp", Order = 6)]
        public IList<string> CommandsOnLevelUp { get; private set; }
        ...
        public ISet<string> ItemNamesAllowed { get; private set; }
        ...
        public ISet<string> PermissionsGranted { get; private set; }
